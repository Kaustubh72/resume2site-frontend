...
@Component({
  ...
  template: `
    <section class="container page-grid">
      ...
      <r2s-file-upload (fileSelected)="handleFile($event)"></r2s-file-upload>
      <r2s-loading-state *ngIf="isUploading" title="Upload placeholder" message="The backend integration will begin in the next implementation step."></r2s-loading-state>
    </section>
  `
})
